...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var rvAdapter: RVAdap
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvMain = findViewById(R.id.rvCeleb)
        btAdd = findViewById(R.id.btnAdd)

        celebrities = arrayListOf()
        rvAdapter = RVAdap(this,celebrities)
        rvMain.adapter = rvAdapter
        rvMain.layoutManager = LinearLayoutManager(this)

        btAdd.setOnClickListener {
            intent = Intent(applicationContext, NewCelebrityActivity::class.java)
        ...
        etCelebrity = findViewById(R.id.etCeleb)
    ...
    private fun updateCelebrity(){
        ...
        for(celebrity in celebrities){
            if(etCelebrity.text.toString().capitalize() == celebrity.name){
                ...
                intent = Intent(applicationContext, UpdateDeleteActivity::class.java)
